import now from './sap/base/util/now.js';
import Version from './sap/base/util/Version.js';
import assert from './sap/base/assert.js';
import Log from './sap/base/Log.js';
import getComputedStyleFix from './sap/ui/dom/getComputedStyleFix.js';
import activeElementFix from './sap/ui/dom/activeElementFix.js';
import includeScript from './sap/ui/dom/includeScript.js';
import includeStylesheet from './sap/ui/dom/includeStylesheet.js';
import SupportHotkeys from './sap/ui/core/support/Hotkeys.js';
import FrameOptions from './sap/ui/security/FrameOptions.js';
import Measurement from './sap/ui/performance/Measurement.js';
import Interaction from './sap/ui/performance/trace/Interaction.js';
import syncXHRFix from './sap/ui/base/syncXHRFix.js';
import LoaderExtensions from './sap/base/util/LoaderExtensions.js';
import Device from './sap/ui/Device.js';
import URI from './sap/ui/thirdparty/URI.js';
import jQuery from './sap/ui/thirdparty/jquery.js';
import './sap/ui/thirdparty/jqueryui/jquery-ui-position.js';
import './ui5loader-autoconfig.js';
import './jquery.sap.stubs.js';
if (!jQuery) {
...
ui5loader.config({ reportSyncCalls: syncCallBehavior });
...
var getModuleSystemInfo = function () {
    var oLog = _ui5loader.logger = Log.getLogger('sap.ui.ModuleSystem', /sap-ui-xx-debug(M|-m)odule(L|-l)oading=(true|x|X)/.test(location.search) || oCfgData['xx-debugModuleLoading'] ? Log.Level.DEBUG : Log.Level.INFO), mKnownSubtypes = LoaderExtensions.getKnownSubtypes(), rSubTypes;
    (function () {
        var sSub = '';
...
(function () {
    ...
    if (!jQuery.browser) {
        jQuery.browser = function (ua) {
            var rwebkit = /(webkit)[ \/]([\w.]+)/, ropera = /(opera)(?:.*version)?[ \/]([\w.]+)/, rmsie = /(msie) ([\w.]+)/, rmozilla = /(mozilla)(?:.*? rv:([\w.]+))?/, ua = ua.toLowerCase(), match = rwebkit.exec(ua) || ropera.exec(ua) || rmsie.exec(ua) || ua.indexOf('compatible') < 0 && rmozilla.exec(ua) || [], browser = {};
            if (match[1]) {
