...
import ObjectPath from './sap/base/util/ObjectPath.js';
import './sap/ui/dom/jquery/control.js';
function fgetUIAreaOfCtrl(oCtrl) {
    return oCtrl.getUIArea().getInterface();
}
function fUIAreaFilter() {
    return sap.ui.getWCCore().getUIArea(this.id) != null;
}
function fgetUIArea() {
    return sap.ui.getWCCore().getUIArea(this.id);
}
jQuery.fn.root = function (oRootControl) {
    if (oRootControl) {
        sap.ui.getWCCore().setRoot(this.get(0), oRootControl);
        return this;
    }
    ...
    this.each(function () {
        sap.ui.getWCCore().createUIArea(this);
    });
    return this;
};
