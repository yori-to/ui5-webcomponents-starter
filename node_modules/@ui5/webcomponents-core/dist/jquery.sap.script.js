...
import uid from './sap/base/util/uid.js';
import hash from './sap/base/strings/hash.js';
import uniqueSort from './sap/base/util/array/uniqueSort.js';
import deepEqual from './sap/base/util/deepEqual.js';
import each from './sap/base/util/each.js';
import diff from './sap/base/util/array/diff.js';
import JSTokenizer from './sap/base/util/JSTokenizer.js';
import merge from './sap/base/util/merge.js';
import UriParameters from './sap/base/util/UriParameters.js';
jQuery.sap.uid = uid;
