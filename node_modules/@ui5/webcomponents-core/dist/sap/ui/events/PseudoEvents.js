...
PseudoEvents.events = {
    ...
    saphide: {
        ...
        aTypes: ['keydown'],
        fnCheck: function (oEvent) {
            return (oEvent.key ? oEvent.key === 'ArrowUp' || oEvent.key === 'Up' : oEvent.keyCode == KeyCodes.ARROW_UP) && checkModifierKeys(oEvent, false, true, false);
        }
    },
    sapleft: {
        sName: 'sapleft',
    ...
    sapskipback: {
        ...
        aTypes: ['keydown'],
        fnCheck: function (oEvent) {
            return (oEvent.key ? oEvent.key === 'F6' : oEvent.keyCode == KeyCodes.F6) && checkModifierKeys(oEvent, false, false, true);
        }
    },
    sapdecrease: {
        sName: 'sapdecrease',
