...
var arrayType = createType('array', { defaultValue: [] });
...
var mTypes = {
    ...
    'function': createType('function', {
        ...
        parseValue: function (sValue, _oOptions) {
            ...
            var fnResult, bLocal, contextObj = _oOptions && _oOptions.context;
            if (sValue[0] === '.') {
                if (contextObj) {
...
DataType.createType = function (sName, mSettings, oBase) {
    ...
    assert(oBase == null || oBase instanceof DataType || typeof oBase === 'string' && oBase, 'DataType.createType: base type must be empty or a DataType or a non-empty string');
    if (/[\[\]]/.test(sName)) {
