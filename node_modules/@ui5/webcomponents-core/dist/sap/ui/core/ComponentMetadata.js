...
import ManagedObjectMetadata from '../base/ManagedObjectMetadata.js';
...
ComponentMetadata.preprocessClassInfo = function (oClassInfo) {
    if (oClassInfo && typeof oClassInfo.metadata === 'string') {
        oClassInfo.metadata = { _src: oClassInfo.metadata };
    }
    return oClassInfo;
};
ComponentMetadata.prototype.applySettings = function (oClassInfo) {
    ...
    if (oStaticInfo._src) {
        ...
        try {
            var oResponse = LoaderExtensions.loadResource(sResource, { dataType: 'json' });
...
ComponentMetadata.prototype._applyManifest = function (oManifestJson) {
    ...
    oManifestJson['sap.app'] = oManifestJson['sap.app'] || { 'id': this.getComponentName() };
...
ComponentMetadata.prototype.getModels = function (bDoNotMerge) {
    ...
    var oParent, mModels = jQuery.extend(true, {}, this._oLegacyModels);
                    ...
                    if (oValue && oValue.length > 0) {
                        for (var i = 0, l = oValue.length; i < l; i++) {
                            ...
                            if (m) {
                                ...
                                oUI5Manifest['resources'][m[1]].push({ 'uri': sResource });
                            }
                        }
                    }
                }
