...
ListFormat.prototype.parse = function (sValue) {
    ...
    var aResult = [], aStart = [], aMiddle = [], aEnd = [], aExactNumber = [], oOriginalFormat = this.oOriginalFormatOptions, mListPatterns, rPlaceholder = /\{[01]\}/g, sEnd, sSeperatorExactNumber, sSeparatorStart, sSeparatorMiddle, sSeparatorEnd;
    if (!oOriginalFormat) {
